      ...
      <div className="p-6 space-y-6">
        <div className="flex items-center justify-between">
          <div className="flex items-center gap-2">
            <GithubLogo />
            <h3 className="text-base font-medium text-octotask-elements-textPrimary dark:text-octotask-elements-textPrimary">
              GitHub Connection
            </h3>
          </div>
        </div>
        ...
        {connection.user && connection.stats && (
          <div className="mt-6 border-t border-octotask-elements-borderColor dark:border-octotask-elements-borderColor pt-6">
            <div className="flex items-center gap-4 p-4 bg-octotask-elements-background-depth-1 dark:bg-octotask-elements-background-depth-1 rounded-lg mb-4">
              <img
              ...
              <CollapsibleTrigger asChild>
                <div className="flex items-center justify-between p-4 rounded-lg bg-octotask-elements-background dark:bg-octotask-elements-background-depth-2 border border-octotask-elements-borderColor dark:border-octotask-elements-borderColor hover:border-octotask-elements-borderColorActive/70 dark:hover:border-octotask-elements-borderColorActive/70 transition-all duration-200">
                  <div className="flex items-center gap-2">
                    ...
                    <span className="text-sm font-medium text-octotask-elements-textPrimary">GitHub Stats</span>
                  </div>
                  <div
                    className={classNames(
                ...
                <div className="space-y-4 mt-4">
                  ...
                  <div className="mt-4">
                    <div className="space-y-4">
                      ...
                      <div>
                        <h5 className="text-sm font-medium text-octotask-elements-textPrimary mb-2">Gists</h5>
                        <div className="grid grid-cols-2 gap-4">
                          {[
                            {
                              label: 'Public',
                  ...
                  <div className="space-y-4">
                    <h4 className="text-sm font-medium text-octotask-elements-textPrimary">Recent Repositories</h4>
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                      {connection.stats.repos.map((repo) => (
                        <a
                          ...
                          target="_blank"
                          rel="noopener noreferrer"
                          className="group block p-4 rounded-lg bg-octotask-elements-background-depth-1 dark:bg-octotask-elements-background-depth-1 border border-octotask-elements-borderColor dark:border-octotask-elements-borderColor hover:border-octotask-elements-borderColorActive dark:hover:border-octotask-elements-borderColorActive transition-all duration-200"
                        >
                          <div className="space-y-3">
                            <div className="flex items-start justify-between">
                              <div className="flex items-center gap-2">
                                <div className="i-ph:git-branch w-4 h-4 text-octotask-elements-icon-tertiary" />
                                <h5 className="text-sm font-medium text-octotask-elements-textPrimary group-hover:text-octotask-elements-item-contentAccent transition-colors">
                                  {repo.name}
                                </h5>
                              </div>
                              <div className="flex items-center gap-3 text-xs text-octotask-elements-textSecondary">
                                <span className="flex items-center gap-1" title="Stars">
                                  <div className="i-ph:star w-3.5 h-3.5 text-octotask-elements-icon-warning" />
                                  {repo.stargazers_count.toLocaleString()}
                                </span>
                                <span className="flex items-center gap-1" title="Forks">
                                  <div className="i-ph:git-fork w-3.5 h-3.5 text-octotask-elements-icon-info" />
                            ...
                            {repo.description && (
                              <p className="text-xs text-octotask-elements-textSecondary line-clamp-2">
                                {repo.description}
                              </p>
                            )}
                            ...
                            <div className="flex items-center gap-3 text-xs text-octotask-elements-textSecondary">
                              ...
                              <span className="flex items-center gap-1 ml-auto group-hover:text-octotask-elements-item-contentAccent transition-colors">
  ...
  return (
    <div className="flex items-center justify-center p-4">
      <div className="flex items-center gap-2">
        ...
        <span className="text-octotask-elements-textSecondary">Loading...</span>
      </div>
    </div>
  );
}
