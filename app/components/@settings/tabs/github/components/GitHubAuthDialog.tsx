  ...
  return (
    <Dialog.Root open={isOpen}>
      <Dialog.Portal>
        ...
        >
          <motion.div
            className="bg-octotask-elements-background border border-octotask-elements-borderColor rounded-lg shadow-lg"
          ...
          >
            <div className="p-6 space-y-6">
              <div className="flex items-center justify-between">
                <h2 className="text-lg font-semibold text-octotask-elements-textPrimary">Connect to GitHub</h2>
                <button
                  onClick={handleClose}
                  className="p-1 rounded-md hover:bg-octotask-elements-item-backgroundActive/10"
                >
                  <div className="i-ph:x w-4 h-4 text-octotask-elements-textSecondary" />
                </button>
              </div>

              <div className="text-xs text-octotask-elements-textSecondary bg-octotask-elements-background-depth-1 p-3 rounded-lg">
              ...
              <form onSubmit={handleConnect} className="space-y-4">
                <div>
                  <label className="block text-sm text-octotask-elements-textSecondary mb-2">Token Type</label>
                  <select
                    value={tokenType}
                    ...
                    className={classNames(
                      ...
                      'focus:outline-none focus:ring-1 focus:ring-octotask-elements-item-contentAccent',
                      'disabled:opacity-50',
                    )}
                  >
                ...
                <div>
                  <label className="block text-sm text-octotask-elements-textSecondary mb-2">
                ...
                <div className="flex items-center justify-end gap-3 pt-4">
                  <button
                    type="button"
                    onClick={handleClose}
                    className="px-4 py-2 text-sm text-octotask-elements-textSecondary hover:text-octotask-elements-textPrimary"
                  >
                    Cancel
                  </button>
                  <button
