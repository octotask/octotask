...
export function WebSearch({ onSearchResult, disabled = false }: WebSearchProps) {
  ...
  return (
    <div ref={containerRef} className="relative">
      ...
      >
        {isSearching ? (
          <div className="i-svg-spinners:90-ring-with-bg text-octotask-elements-loader-progress text-xl animate-spin" />
        ) : (
      ...
      {isOpen && (
        <div
          className={classNames(
            ...
            'rounded-lg border border-octotask-elements-borderColor bg-octotask-elements-background-depth-2 p-2 shadow-lg',
          )}
        >
          <input
            ref={inputRef}
            ...
            className={classNames(
              ...
              'bg-octotask-elements-background-depth-1 text-octotask-elements-textPrimary',
              'placeholder-octotask-elements-textTertiary',
          ...
          <button
            ...
            className={classNames(
              ...
              'bg-octotask-elements-button-primary-background text-octotask-elements-button-primary-text',
