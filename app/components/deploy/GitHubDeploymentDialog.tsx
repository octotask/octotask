    ...
    try {
      ...
      try {
        ...
        const { data: commitData } = await octokit.git.createCommit({
          owner: connection.user.login,
          repo: sanitizedRepoName,
          message: !repoExists ? 'Initial commit from Octotask' : 'Update from Octotask',
          tree: treeData.sha,
              ...
              >
                ...
                <div className="relative text-center space-y-4">
                  ...
                  <motion.div
                    ...
                    className="mx-auto w-16 h-16 rounded-xl bg-octotask-elements-background-depth-3 flex items-center justify-center text-purple-500"
                  >
              ...
              <div className="p-6">
                <div className="flex items-center gap-4 mb-6">
                  <motion.div
                    ...
                    animate={{ scale: 1 }}
                    transition={{ delay: 0.1 }}
                    className="w-10 h-10 rounded-xl bg-octotask-elements-background-depth-3 flex items-center justify-center text-purple-500"
                  >
                ...
                <form onSubmit={handleSubmit} className="space-y-4">
                  <div className="space-y-2">
                    ...
                    {repoName && sanitizeRepoName(repoName) !== repoName && (
                      <p className="text-xs text-octotask-elements-textSecondary dark:text-octotask-elements-textSecondary-dark mt-1">
                        Will be created as:{' '}
                            ...
                            >
                              <div className="flex items-center justify-between">
                                <div className="flex items-center gap-2">
                                  ...
                                  <span className="text-sm font-medium text-octotask-elements-textPrimary dark:text-octotask-elements-textPrimary-dark group-hover:text-purple-500">
                                    {repo.name}
                                  </span>
                                </div>
                                {repo.private && (
                  ...
                  <div className="p-3 bg-octotask-elements-background-depth-2 dark:bg-octotask-elements-background-depth-3 rounded-lg border border-octotask-elements-borderColor dark:border-octotask-elements-borderColor-dark">
                    <div className="flex items-center gap-2">
                      <input
                        ...
                        className="rounded border-octotask-elements-borderColor dark:border-octotask-elements-borderColor-dark text-purple-500 focus:ring-purple-500 dark:bg-octotask-elements-background-depth-3"
                      />
                      <label
                        htmlFor="private"
