  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-octo-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-octo-elements-background-depth-2 border-y border-octo-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-octo-elements-terminals-buttonBackground text-octo-elements-textSecondary hover:text-octo-elements-textPrimary':
                            isActive,
                          'bg-octo-elements-background-depth-2 text-octo-elements-textSecondary hover:bg-octo-elements-terminals-buttonBackground':
                            !isActive,
                        },
                      )}
                    ...
                    <React.Fragment>
                      <button
                        ...
                        className={classNames(
                          'flex items-center text-sm cursor-pointer gap-1.5 px-3 py-2 h-full whitespace-nowrap rounded-full',
                          {
                            'bg-octo-elements-terminals-buttonBackground text-octo-elements-textPrimary': isActive,
                            'bg-octo-elements-background-depth-2 text-octo-elements-textSecondary hover:bg-octo-elements-terminals-buttonBackground':
                              !isActive,
                          },
                        )}
                      ...
                      >
                        ...
                        <button
                          className="bg-transparent text-octo-elements-textTertiary hover:text-octo-elements-textPrimary hover:bg-transparent rounded"
                          onClick={(e) => {
                            e.stopPropagation();
                            closeTerminal(index);
                          }}
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachOctoTerminal(terminal);
                  } else {
          ...
          {Array.from({ length: terminalCount + 1 }, (_, index) => {
            ...
            logger.debug(`Starting octo terminal [${index}]`);
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachOctoTerminal(terminal)}
