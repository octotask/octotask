  ...
  return (
    ...
    >
      <div className="h-full">
        <div className="bg-octotask-elements-terminals-background h-full flex flex-col">
          <div className="flex items-center bg-octotask-elements-background-depth-2 border-y border-octotask-elements-borderColor gap-1.5 min-h-[34px] p-2">
                  ...
                  {index == 0 ? (
                    <button
                      ...
                      className={classNames(
                        ...
                        {
                          'bg-octotask-elements-terminals-buttonBackground text-octotask-elements-textSecondary hover:text-octotask-elements-textPrimary':
                            isActive,
            ...
            <IconButton
              ...
              onClick={() => {
                ...
                if (ref?.getTerminal()) {
                  ...
                  if (activeTerminal === 0) {
                    workbenchStore.attachOctotaskTerminal(terminal);
                  } else {
              ...
              return (
                <React.Fragment key={`terminal-container-${index}`}>
                  <Terminal
                    ...
                    onTerminalReady={(terminal) => workbenchStore.attachOctotaskTerminal(terminal)}
